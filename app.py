'''
######################This chunk plays the original mp4 in local web######################
...
def draw_lines(image, lines, color=[255, 0, 0], thickness=2, make_copy=True):
    ...
    print(" Num of lines detected: ", len(cleaned))
    return image
...
cwd = os.getcwd()
top_model_weights_path = 'base_model.h5'
...
model = keras.models.load_model(top_model_weights_path)
